...
;-------------------------------------
  ...
  .area 24  ;We have 24 bytes here
    ldrsh   r3,[r0,8h]
    mov     r0,r3
    bl LevelListSecondHWORDGet;ldr     r2,=20A5BDAh ;OK
    mov     r2,r0
...
;-------------------------------------
  ...
  .area 0x14  ;We have 20 bytes here
    ...
    mov     r4,r0               ;022F1354 E59F41E4 ldr     r4,=20A5BD8h ;OK
    ldrsh   r0,[r4]             ;022F1358 E19400F3 ldrsh   r0,[r4,r3]
    nop                         ;022F135C E0844003 add     r4,r4,r3
  .endarea
  .org 0x22F1EE4         ;We need to modify the address here, to use it for our bl above! OK
  .area 4
    .pool
  .endarea
...
;-------------------------------------
  ...
  .area 0x14
    ...
    mov     r4,r0                 ;022F1608 E59F20EC ldr     r2,=20A5BD8h ;OK
  ...
  .org 0x22F20FC ;OK
  .area 24
    mov     r0,r4               ;022F1758 E59F1034 ldr     r1,=20A5BD8h   //<-change       //Level list beg; OK
  ...
  ;-------------------------------------
  ; Hook 0x22F2158 - This one caused misalignment in the stack!!
  ;-------------------------------------
  .org 0x22F2158 ;OK
  .area (0x22F2188 - 0x22F2158) ;OK
    push r14                  ;022F17B4 E59F0024 ldr     r0,=2325800h ;OK
    ldr     r0,=2325800h       ;022F17B8 E5900004 ldr     r0,[r0,4h] ;OK
    ...
    bl      LevelListAccessor ;022F17D0 E59F100C ldr     r1,=20A5BD8h
    ldrsh   r0,[r0]           ;022F17D4 E1600082 smulbb  r0,r2,r0
    pop     r15               ;022F17D8 E19100F0 ldrsh   r0,[r1,r0]
    .pool                     ;022F17DC E12FFF1E bx      r14
    ;.fill   (0x22F2158 + 0x22F2188) - . ;022F17E0 02324CC0 eoreqs  r4,r2,0C000h ;OK
    ;022F2188 020A5BD8 andeq   r5,r10,88000000h ;OK
  .endarea
  ...
  .org 0x22F290C ;OK
  .area 20
    nop ;mov     r0,r4             ;022F1F68 E3A0300C mov     r3,0Ch ;OK
    mov     r1,r7             ;!! Don't Touch !!
    mov     r2,r6             ;!! Don't Touch !!
    bl      LevelListCustomHook022F290C ;022F1F74 E1640384 smulbb  r4,r4,r3 ;;<== Custom hook for this one since we don't have much space, and a lot of registers are in use!
    nop ;022F1F78 E59F50C8 ldr     r5,=20A5BD8h ;;;Put the result into r4 since r0 gets overwritten several times after, not r4 and r5 OK
  .endarea
  .org 0x22F297C ;OK
  .area 4
  ...
  .area 24
    push r14
    mov     r0,r1                 ;022FF9FC E59F200C ldr     r2,=20A5BD8h ;OK
    ...
    ;023003AC 020A5BD8 andeq   r5,r10,88000000h ;OK
  .endarea
  ...
  .area 20
    ...
    mov     r4,r0             ;02310110 E59F3210 ldr     r3,=20A5BD8h ;OK
  ...
  .org 0x23117D8 ;OK
  .area 4
    mov     r0,r4  ;02310E3C E59F0080 ldr     r0,=20A5BD8h  //<-change ;OK
  .endarea
  ...
  .area 20
    ...
    mov     r4,r0             ;02311114 E59F315C ldr     r3,=20A5BD8h ;OK
  ...
  .area 20
    ...
    mov     r4,r0             ;023125DC E59F3138 ldr     r3,=20A5BD8h ;OK
